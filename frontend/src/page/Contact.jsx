    ...
    >
            <div className='mx-auto'>
                <div className='min-h-screen flex items-center justify-center'>
                    <form onSubmit={handleSubmit} className='shadow-lg rounded-lg p-6 w-full max-w-sm'>
                        ...
                        <div className='space-y-5 mt-5'>
                            ...
                            <button
                                type='submit'
                                className='w-full bg-linear-to-r from-blue-600 to-indigo-600 text-white px-4 py-2 rounded-md cursor-pointer hover:from-blue-700 hover:to-indigo-700 duration-300 hover:scale-[1.02]'
                            >
                                Sent Message
                            </button>
                        </div>
